...
dot_fixture_copy_core() {
  local engine_root="${1:-${DOT_TEST_ENGINE_ROOT:-$REAL_HOME/.local/lib/dotfiles/legacy-dot/core}}"

  mkdir -p "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core"
  cp "$engine_root/"*.sh "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/"
  cp -R "$engine_root/doctor" "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/"
  cp -R "$engine_root/repos" "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/"
}
...
dot_fixture_source_core_init() {
  local engine_root="${1:-${DOT_TEST_ENGINE_ROOT:-$TEST_HOME/.local/lib/dotfiles/legacy-dot/core}}"
