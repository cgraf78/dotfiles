...
_dot_test_merge_hook_names() {
  ...
  tracked_hooks=$(git "${git_args[@]}" ls-files -- \
    ':(glob).local/lib/dotfiles/legacy-dot/core/merge-hooks/*.sh') || return 1
...
TOOL_COMMANDS
  ...
  mkdir -p "$merge_hook_inventory_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/lib"
  printf '# tracked base hook\n' \
    >"$merge_hook_inventory_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/git.sh"
  printf '# tracked support file, not a top-level hook\n' \
    >"$merge_hook_inventory_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/lib/support.sh"
  printf '# untracked overlay hook\n' \
    >"$merge_hook_inventory_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/overlay-extension.sh"
  git -C "$merge_hook_inventory_home" init -q
  git -C "$merge_hook_inventory_home" add \
    .local/lib/dotfiles/legacy-dot/core/merge-hooks/git.sh \
    .local/lib/dotfiles/legacy-dot/core/merge-hooks/lib/support.sh
  ...
  printf '# untracked overlay hook\n' \
    >"$merge_hook_linked_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/overlay-extension.sh"
  ...
  mkdir -p "$merge_hook_dotfiles_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/lib"
  printf '# tracked base hook\n' \
    >"$merge_hook_dotfiles_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/git.sh"
  printf '# tracked support file, not a top-level hook\n' \
    >"$merge_hook_dotfiles_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/lib/support.sh"
  printf '# untracked overlay hook\n' \
    >"$merge_hook_dotfiles_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/overlay-extension.sh"
  ...
  while IFS= read -r hook_name; do
    hook_path="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/$hook_name.sh"
...
YQ
  ...
  _run_agent_cli_gate_for_test() (
    ...
    # shellcheck source=/dev/null
    . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/$agent.sh"
    case "$agent" in
      codex)
        # shellcheck disable=SC2329 # Invoked indirectly by the sourced hook.
  ...
  opencode_hook="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/opencode.sh"
...
TMUX
  ...
  _run_tmux_merge_for_test() {
    unset -f merge 2>/dev/null
    # shellcheck source=/dev/null
    . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/tmux.sh"
    merge
  }
...
PGREP
  ...
  _run_nvim_merge_for_test() {
    unset -f merge 2>/dev/null
    # shellcheck source=/dev/null
    . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/nvim.sh"
    merge
  }
...
GIT_CONFIG
  ...
  HOME="$git_home" GIT_CONFIG_GLOBAL="$git_home/.gitconfig" \
    bash -c '
      ...
      merge
      merge
    ' _ "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/git.sh"
...
JSON
    ...
    (
      ...
      . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/claude.sh"
...
JSON
    ...
    (
      . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/muse.sh"
...
EOF
    ...
    _run_karabiner_merge_for_test() {
      unset -f merge 2>/dev/null
      # shellcheck source=/dev/null
      . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/karabiner.sh"
      merge
    }
...
YAML
    _run_gh_merge_for_test() {
      unset -f merge 2>/dev/null
      # shellcheck source=/dev/null
      . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/gh.sh"
      merge
    }
...
EOF
  ...
  _run_iterm2_merge_for_test() {
    unset -f merge 2>/dev/null
    # shellcheck source=/dev/null
    . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/iterm2.sh"
    merge
  }
  HOME="$iterm2_home" \
...
EOF
  ...
  env HOME="$sl_missing_hook_home" REAL_HOME="$REAL_HOME" PATH="$sl_gate_bin:$PATH" bash -c '
    set -euo pipefail
    # shellcheck source=/dev/null
    . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-block.sh"
    _log() { :; }
    # shellcheck source=/dev/null
    . "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/sapling.sh"
    merge
  '
...
EOF
  ...
  _SSHD_HOOK="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/sshd.sh"
  ...
  _SSH_HOOK="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/ssh.sh"
...
EXISTING
  ...
  _IGNORE_HOOK="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/ignore.sh"
...
JQ
  ...
  _CLAUDE_HOOK="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/claude.sh"
...
JSON
  ...
  _CODEX_HOOK="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/codex.sh"
...
" "$CODEX_CONFIG" 2>/dev/null; then
  ...
  _HIVE_HOOK="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/hive-memory.sh"
  _HIVE_BIN=$(_mock_bin)
...
HM
  ...
  mkdir -p "$_HIVE_SYMLINK_HOME/.local/share/hive-memory/bin" \
    ...
    "$_HIVE_SYMLINK_HOME/.local/lib/dotfiles/legacy-dot/hive-memory" \
  ...
  cp "$_HIVE_LEGACY_HOME/.local/bin/hm" \
    "$_HIVE_SYMLINK_HOME/.local/lib/dotfiles/legacy-dot/hive-memory/hm-launcher"
...
TOML
  ...
  _MISE_HOOK="$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/mise.sh"
...
GH
  ...
  mkdir -p "$merge_lifecycle_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks"
  printf '%s\n' 'caller payload' >"$merge_lifecycle_input"

  cat >"$merge_lifecycle_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/10-mutator.sh" <<'MERGE'
merge() {
...
MERGE
  ...
  cat >"$merge_lifecycle_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/20-observer.sh" <<'MERGE'
merge() {
...
MERGE
  ...
  cat >"$merge_lifecycle_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/cron.sh" <<'MERGE'
merge() {
    printf 'Serial label\n'
}
MERGE

  cat >"$merge_lifecycle_home/.local/lib/dotfiles/legacy-dot/core/merge-hooks/z-after.sh" <<'MERGE'
merge() {
    printf 'After label\n'
}
MERGE
...
err_trap=preserved" \
  ...
  mkdir -p "$TEST_HOME/.config/dot/merge-hooks.d" \
    "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks"
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/testapp.sh" <<'MERGE'
merge() {
    echo "Test app"
...
MERGE
  ...
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/otherapp.sh" <<'MERGE'
merge() {
    echo "Other app"
}
MERGE
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/no-config.sh" <<'MERGE'
merge() {
    echo "No config app"
}
MERGE
...
MERGE
  ...
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/dirapp.sh" <<'MERGE'
merge() {
    echo "Dir app"
}
MERGE
...
MERGE
  ...
  _assert_eq "merge label: preserves hook stem separators" \
    "hive-memory" \
    "$(_merge_label_from_script "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/hive-memory.sh")"
  ...
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/parallel-a.sh" <<'MERGE'
merge() {
    echo "Parallel A"
...
MERGE
  ...
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/parallel-b.sh" <<'MERGE'
merge() {
    echo "Parallel B"
...
MERGE
  ...
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/failapp.sh" <<'MERGE'
merge() {
    return 7
}
MERGE
  ...
  rm -f "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks"/*.sh
  ...
  cat >"$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/goodapp.sh" <<'MERGE'
merge() {
    echo "Good app"
}
MERGE
  ln -s "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/missing-target.sh" \
    "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/dangling.sh"
