...
dot_core_test_commands() {
  ...
  UPDATE_LOCK_MODULE="$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/update-lock.sh"
...
CONF
    ...
    mkdir -p "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks"
...
MERGE
    ...
    rm -f "$TEST_HOME/.local/lib/dotfiles/legacy-dot/core/merge-hooks/failapp.sh"
...
CONF
    ...
    mkdir -p "$NO_REPO_HOME/.local/lib/dotfiles/legacy-dot/core"
    cp "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/"*.sh "$NO_REPO_HOME/.local/lib/dotfiles/legacy-dot/core/"
    cp -R "$REAL_HOME/.local/lib/dotfiles/legacy-dot/core/repos" "$NO_REPO_HOME/.local/lib/dotfiles/legacy-dot/core/"
