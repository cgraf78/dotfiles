...
This directory contains human-facing dotfiles documentation that is broader
than a single config directory.

- `dot.md` is the main operating guide for bootstrapping, updating, overlays,
